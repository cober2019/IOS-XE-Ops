...
def db_update_nexus(mydb, cursor, vdc=None, vrf=None, prefix=None, protocol=None, admin_distance=None,
...
def db_update_asa(mydb, cursor, vrf=None, prefix=None, protocol=None, admin_distance=None, nexthops=None,
                  interfaces=None, metric=None, age=None, tag=None) -> None:
